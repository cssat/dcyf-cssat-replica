...
CASE WHEN id_routing_organization IN (339, 340, 341, 342, 343) THEN 1 ELSE 0 END AS "FL_Referral_72_Hour",
...
dt_final_visit_scheduling_confirmation "DT_Latest_Visit_Scheduling_Confirmation",
